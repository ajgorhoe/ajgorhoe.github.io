...
set ModuleDirRelative=IGLibFrameworkCodedoc
set CheckoutBranch=main
set RepositoryAddress=https://github.com/ajgorhoe/IGLibFrameworkCodedoc.git
set RepositoryAddressSecondary=
set RepositoryAddressLocal=
set Remote=origin
set RemoteSecondary=
set RemoteLocal=downstream_PowerShell
